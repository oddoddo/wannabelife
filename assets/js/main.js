...
$(document).ready(function ($) {
    ...
    $(function () {
        ...
        $('.soon-countdown .row').countdown({
            ...
            render: function (data) {
                $(this.el).html(
                    '<div><div><span>' +
                        (parseInt(this.leadingZeros(data.years, 2) * 365) + parseInt(this.leadingZeros(data.days, 2))) +
    ...
    $('.play').click(function () {
        $('.screenshots-carousel').slick('slickPlay')
        $(this).hide()
        $('.stop').show()
    })

    $('.stop').click(function () {
        $('.screenshots-carousel').slick('slickPause')
        $(this).hide()
        $('.play').show()
    })
})
